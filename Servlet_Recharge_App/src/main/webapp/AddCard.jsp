...
<%@page import="recharge.model.Account"%>
...
<body>
	<div class="container">
		...
		<div class="card-container">
			...
			<div class="front">
				<div class="image">
					<img src="image/chip.png" alt=""> <img src="image/visa.png"
						alt="">
				</div>
		...
		<form action="AddCardController" name="myForm">

			<div class="inputBox">
				<span>card number</span> <input type="text" maxlength="16" 
					class="card-number-input" name="accNo">
			</div>
			<div class="inputBox">
				<span>card holder</span> <input type="text"
					class="card-holder-input" name="accName">
			</div>
			<div class="inputBox">
				<span>account balance</span> <input type="text"
					class="acc-balance-input" name="accBal">
			</div>
			<div class="flexbox">
				<div class="inputBox">
				...
				<div class="inputBox">
					<span>cvv</span> <input type="text" maxlength="3" class="cvv-input"
						name="cvv">
				</div>
			</div>
...
function  validateForm() {
    ...
    if (accNo.length !== 16 || isNaN(accNo)) {
